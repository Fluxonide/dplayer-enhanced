...
| video.thumbnails     | -                                  | video thumbnails, generated by [DPlayer-thumbnails](https://github.com/Fluxonide/DPlayer-thumbnails)                                                       |
...
| danmaku.user         | 'Fluxonide'                           | danmaku user name                                                                                                                                          |
...
-   `dp.on(event: string, handler: function)`: bind video and player events, [see more details](https://dplayer.Fluxonide.dev/guide.html#event-binding)
